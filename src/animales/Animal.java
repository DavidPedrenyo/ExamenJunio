...
public abstract class Animal {
     ...
     * - Un número de dos cifras que represente el día del mes. Si el día solo tiene una cifra, deberá ponerse un 0 delante. Ejemplo: 01 - Un guión (-) o una barra (/) para separar el día del mes. 
     * - Un número de dos cifras que represente el mes del año, entre 1 y 12. Si el número del mes solo tiene una cifra, deberá ponerse un 0 delante. Ejemplo: 02 para febrero 
     * - Un guión (-) o una barra (/) para separar el mes del año. - Un número para representar el año
     ...
     * @exception IllegalArgumentException --> Si alguno de los argumentos no cumple con las condiciones establecidas para ser considerados correctos
